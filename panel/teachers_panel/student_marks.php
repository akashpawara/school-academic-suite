                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <h4 class="tittle-w3-agileits mb-4">Select Class</h4>
                            ...
                            <br>
                            <div class="form-group row">
                                    <label for="country">Exam Type</label>
                            ...
                            <div class="form-group row">
                                    <label for="country">Term</label>
                                        <select class="custom-select d-block w-100" id="term" name="term" required="">
                                            <option value="">Choose...</option>
                            ...
                            <div class="form-group row">
                                    ...
                                    <input type="text" name="year" id="date" class="form-control"  required="">
                                </div>
                            </br>
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button type="submit" name="pushMarks" class="btn btn-primary">Submit</button>
                                    </div>
                                </div>
                            </form>
                    </div>
                    ...
                    <div class="row">
                    <div class="outer-w3-agile col-xl">
                    <form action="push_marks.php" method="POST">
                        <h4 class="tittle-w3-agileits mb-4">Enter Marks</h4>
                    <table class="table">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="english[<?php echo "{$row3['sID']}" ?>]" id="inputCity" required="" style="width: 40%; border-color: black;"></td>
                                <td><input type="text" class="form-control" name="maths[<?php echo "{$row3['sID']}" ?>]" id="inputCity" required="" style="width: 40%; border-color: black;"></td>
                                <td><input type="text" class="form-control" name="science[<?php echo "{$row3['sID']}" ?>]" id="inputCity" required="" style="width: 40%; border-color: black;"></td>
                            </tr>
                            <?php
                                $q++;
                                    }
                            ...
                            <button type="submit" name="push_marks" class="btn btn-primary">Submit</button>
                                </form>
                    </<div>
                                <?php } ?>
                </div>
