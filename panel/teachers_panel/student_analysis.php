        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <h4 class="tittle-w3-agileits mb-4">Select Class</h4>
                            <form action="#" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        <button type="submit" name="pushAnalysis" class="btn btn-primary">Submit</button>
                                    </div>
                                </div>
                            </form>
                    </div>
                    ...
                    <!-- Pie-chart -->
                    <div class="outer-w3-agile col-xl">
                        <h4 class="tittle-w3-agileits mb-4">Class Attendence Analysis</h4>
                        <?php
                            if(isset($_POST['pushAnalysis']))
                            {
                        ?>
                        <div id="chart-1"></div>
                        <?php
